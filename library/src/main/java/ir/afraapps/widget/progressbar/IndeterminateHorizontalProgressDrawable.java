...
public class IndeterminateHorizontalProgressDrawable extends BaseIndeterminateProgressDrawable
  ...
  private static final int PROGRESS_INTRINSIC_HEIGHT_DP = 2;
  ...
  public IndeterminateHorizontalProgressDrawable(Context context) {
    ...
    Log.i("progress_drawable", "create progress");
    ...
    mAnimators.clear();
    mAnimators.add(Animators.createIndeterminateHorizontalRect1(mRect1TransformX));
    mAnimators.add(Animators.createIndeterminateHorizontalRect2(mRect2TransformX));
