...
class Animators {
   ...
   */
  @SuppressLint("ObjectAnimatorBinding")
  public static Animator createSmoothProgress(Object target, float fromProgress, float toProgress) {
    ObjectAnimator trimPathEndAnimator = ObjectAnimator.ofFloat(target, "trimPathEnd",
      fromProgress, toProgress);
    // trimPathEndAnimator.setDuration(1333);
    //  trimPathEndAnimator.setInterpolator(Interpolators.TRIM_PATH_END.INSTANCE);
    trimPathEndAnimator.setDuration(1333);
    trimPathEndAnimator.setInterpolator(new DecelerateInterpolator(2.0f));
    return trimPathEndAnimator;
  }
   ...
   */
  @SuppressLint("ObjectAnimatorBinding")
  public static Animator createIndeterminateRotation(Object target, float start) {
    ObjectAnimator rotationAnimator = ObjectAnimator.ofFloat(target, "rotation", start, start + 720);
    rotationAnimator.setDuration(6665);
    rotationAnimator.setInterpolator(Interpolators.LINEAR.INSTANCE);
    rotationAnimator.setRepeatCount(ValueAnimator.INFINITE);
    return rotationAnimator;
