...
package ir.afraapps.widget.progressbar.compat;
...
class ObjectAnimatorCompatBase {
  ...
  private static void calculateXYValues(Path path, float[] xValues,
                                        float[] yValues) {
  ...
  private static void calculateXYValues(Path path, int[] xValues,
                                        int[] yValues) {
